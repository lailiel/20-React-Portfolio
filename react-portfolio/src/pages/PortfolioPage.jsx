...
const PortfolioPage = () => {
    const [projects, setProjects] = useState ([
        ...
        { name: 'Social Network API', skillsUsed: 'noSQL', gitLink: 'https://github.com/lailiel/18-Social-Network-Api', link: 'https://github.com/lailiel/18-Social-Network-Api', image: './src/assets/projectimages/SocialNetworkApi.jpg'},
        ...
        { name: 'E-Commerce Back End', skillsUsed: 'ORM', gitLink: 'https://github.com/lailiel/13-E-Commerce-Back-End', link: 'https://github.com/lailiel/13-E-Commerce-Back-End', image: './src/assets/projectimages/EcommerceBackend.jpg'},
        { name: 'Employee Tracker', skillsUsed: 'SQL', gitLink: 'https://github.com/lailiel/12-Employee-Tracker', link: 'https://github.com/lailiel/12-Employee-Tracker', image: './src/assets/projectimages/EmployeeTracker.jpg'},
        ...
        { name: 'Logo Generator', skillsUsed: 'OOP', gitLink: 'https://github.com/lailiel/10-Logo-Generator', link: 'https://github.com/lailiel/10-Logo-Generator', image: './src/assets/projectimages/LogoGenerator.jpg'},
        { name: 'Read-me Generator', skillsUsed: 'NodeJS', gitLink: 'https://github.com/lailiel/09-ReadMe-Generator', link: 'https://github.com/lailiel/09-ReadMe-Generator', image: './src/assets/projectimages/ReadmeGenerator.jpg'},
